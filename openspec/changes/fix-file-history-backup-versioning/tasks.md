...
- [ ] 1.1 Add a `next_backup_version(backup_dir: &Path, hex_prefix:
...
- [ ] 1.2 In `Session::append_file_history_snapshot_for_path`,
...
- [ ] 1.3 Ordering invariant: `create_dir_all(&backup_dir)` MUST
...
- [ ] 1.4 Entries in `backup_dir` that do not match the
...
- [ ] 2.2
      ...
      `"b"`.
- [ ] 2.3 Both tests share the existing `ctx_with_real_session`
...
- [ ] 6.2 Flip the P0 #6 ⚠️ footnote in
